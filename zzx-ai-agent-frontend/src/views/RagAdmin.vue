          ...
          <template v-if="selectedDocument">
            ...
            <div class="viewer-body">
              ...
              <div v-else class="chunks-view">
                ...
                <template v-else>
                  <article v-for="chunk in chunks" :key="chunk.index" class="chunk-card">
                    <header>
